...
3. Explain these distinct capabilities:
   ...
   - manual and pull-request Advisory GitHub Actions validation.
...
5. State that install or refresh never writes `.github`, setup never configures runners or branch protection, and package validation does not publish, deploy, contact external services, or modify game content.
